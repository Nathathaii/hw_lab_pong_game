...
HD_PWD='C:/Users/Nathathai/Documents/chula year 3.1/HW syn lab/vivado/pong_1player/pong_1player.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pong_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pong_top.tcl
